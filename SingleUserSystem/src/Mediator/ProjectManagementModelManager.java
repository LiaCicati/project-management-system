...
public class ProjectManagementModelManager implements ProjectManagementModel
{
    ...
    {
        Project project1 = new Project("Rental Company",
            new MyDate(18, 12, 2020), 35, "some description");
        Project project2 = new Project("VIA University",
            new MyDate(23, 12, 2020), 38, "some description");
    ...
    @Override public void editTeamMember(int projectID, int ID, Name name,
        int teamMemberID, String role)
    {
        projectList.getProjectById(projectID).getAllTeamMembers()
            .getTeamMemberById(ID).setName(name);
        projectList.getProjectById(projectID).getAllTeamMembers()
            .getTeamMemberById(ID).setId(teamMemberID);
        projectList.getProjectById(projectID).getAllTeamMembers()
